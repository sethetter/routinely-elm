...
var _user$project$Routinely$logsForDay = function (day) {
	return _elm_lang$core$List$filter(
		function (log) {
			var _p0 = _elm_lang$core$Date$fromString(log.createdAt);
			if (_p0.ctor === 'Ok') {
				return _elm_lang$core$Native_Utils.eq(
					_elm_lang$core$Date$dayOfWeek(_p0._0),
					day);
			} else {
				return false;
			}
...
var _user$project$Routinely$daysAwayFromMonday = function (time) {
	var _p2 = _elm_lang$core$Date$dayOfWeek(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								weeklyActionLogs: A2(
									_elm_lang$core$List$filter,
									function (l) {
										var _p4 = _elm_lang$core$Date$fromString(l.createdAt);
										if (_p4.ctor === 'Ok') {
											return _elm_lang$core$Native_Utils.cmp(
												_elm_lang$core$Date$toTime(_p4._0),
												mostRecentMonday) > -1;
										} else {
											return false;
										}
